...
import downtown from "../images/downtown-athens.png"
        ...
        <>
            ...
            <div className="flex w-full h-fit bg-[#FFCBA7] justify-center px-[10px] pb-[50px]">
                <div className="flex flex-col w-[854px] h-[754px] justify-between items-center">
                    <h1 className="text-[#5F120C] font-bold text-center font-playfair text-[96px] drop-shadow-[6px_4px_4px_rgba(0,0,0,0.6)]">
                        HARVEST<br />
                        <h1 className="text-[64px]"> -ATHENS-</h1>
                    </h1>
                    <h3 className="text-[#5F120C] font-playfair text-[48px] border-solid font-bold text-center">
                        Fridays @ 8:30<br />
                        THE ROOK & PAWN
                    </h3>
                    <p className="text-[#6A6A6A] font-lato text-[32px]">
